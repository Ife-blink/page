  ...
  return (
    <section className='h-[100%] w-[100%] py-[5%] bg-black px-[3%]'>
        ...
        <div className='bg-purple-700 col-span-3 overflow-hidden '>
         ...
         <h2 className='font-sans font-semibold text-[6rem] leading-[2rem] text-white'>project</h2>
         </div>
         <div className=''>
         </div>
         ...
         <h2 className='font-sans font-semibold text-[6rem] leading-[2rem] text-white'>inquiry</h2>
         </div>
         </div>
        </div>
        </div>
